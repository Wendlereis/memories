...
public class FormPesquisarLancamentoController implements Initializable {
    ...
    void btnConsultarAction(ActionEvent event) {
        ...
        list = new ArrayList<>();
        list = lancamentoDAO.listarLancamento(txtPesquisa.getText(), this.grupo);
    ...
    void btnAlterarAction(ActionEvent event) throws IOException {
        ...
        controller.initWithData(grupo, selectedLancamento);
